        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
                  <span class="avatar avatar-sm rounded-circle">
                    <img alt="Image placeholder" src="/img/theme/image-1.png">
                  </span>
            <b-media-body class="ml-2 d-none d-lg-block">
              <span v-if="user.account.role != 0" class="mb-0 text-sm  font-weight-bold">{{user.fullname}}</span>
              <span v-else class="mb-0 text-sm  font-weight-bold">Admin</span>
            </b-media-body>
          </b-media>
        </a>
