                ...
                <b-tab title="Grade 10" active>
                    <b-col>
                        <b-card-header class="border-0">
                            <h2 class="text-uppercase" align="center">Statistical report on the number of conduct results</h2>
...
export default {
  ...
  methods: {
    fetchData_grade1() {
      ...
      let url = "http://localhost:8000/api/admin/grade/conduct/report/"+this.text+"/"+ 1;
      get(url)
        .then((res) => {
          this.post_1 = res.data;
        //   console.log("post_1",this.post_1)
    ...
    fetchData_grade2() {
      ...
      let url = "http://localhost:8000/api/admin/grade/conduct/report/"+this.text+"/"+ 2;
      get(url)
        .then((res) => {
    ...
    fetchData_grade3() {
      ...
      let url = "http://localhost:8000/api/admin/grade/conduct/report/"+this.text+"/"+ 3;
      get(url)
        .then((res) => {
